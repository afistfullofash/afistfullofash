(define-module (afistfullofash home services notification)
  #:use-module (gnu)
...
(define-record-type* <home-dunst-configuration>
  ...
  (config home-dunst-extra-config-data (default #f)))
   ...
   (extensions
    (list
     (service-extension home-xdg-configuration-files-service-type
			(lambda (config)
			  (if (home-dunst-base-config-data config)
			      (home-dunst-config-modification config)
			      '())))
